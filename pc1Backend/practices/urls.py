...
urlpatterns = [
	...
	path('entities/<slug:slug>/practices', views.EntityPractices.as_view(), name="entity_practices"),
	path('entities/<slug:slug>/providers', views.EntityProviders.as_view(), name="entity_providers"),
	path('daily_summaries/', views.FilteredDailySummaries.as_view(), name='entity_daily_summaries'),
